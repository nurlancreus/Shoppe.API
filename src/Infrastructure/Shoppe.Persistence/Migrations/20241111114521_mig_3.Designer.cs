...
namespace Shoppe.Persistence.Migrations
{
    ...
    [Migration("20241111114521_mig_3")]
    partial class mig_3
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Shoppe.Domain.Entities.About", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("e228fed4-7cfd-4d5f-aab9-48193791c309"),
                            CreatedAt = new DateTime(2024, 11, 11, 11, 45, 20, 983, DateTimeKind.Utc).AddTicks(7579),
            ...
            modelBuilder.Entity("Shoppe.Domain.Entities.Identity.ApplicationUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "admin-user-id",
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "e20998fb-8819-43d2-a3cd-8f642aa86596",
                            CreatedAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            ...
                            PasswordHash = "AQAAAAIAAYagAAAAEKKW2FNpAFYVT8iXVX+blZPYjIe/qS8RvwTbbpEv7UChVjD9pN7UweQifhHLmS1Wkw==",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "933f8d32-1deb-4b7a-abc1-cc19f282ac52",
