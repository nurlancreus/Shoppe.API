...
namespace Shoppe.Persistence.Migrations
{
    ...
    [Migration("20241224141926_mig_3")]
    partial class mig_3
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Shoppe.Domain.Entities.Address", b =>
                {
                    ...
                    b.HasIndex("FirstName", "LastName", "Email", "Country", "City", "PostalCode", "StreetAddress")
                        .IsUnique();
            ...
            modelBuilder.Entity("Shoppe.Domain.Entities.Address", b =>
                {
                    b.HasOne("Shoppe.Domain.Entities.Identity.ApplicationUser", "Account")
                        .WithOne()
                        .HasForeignKey("Shoppe.Domain.Entities.Address", "UserId")
